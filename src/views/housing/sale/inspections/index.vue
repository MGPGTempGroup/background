<template>
  <div class="sale-house-inspections" >
    <el-table
      v-loading="tableLoading"
      :data="saleInspections.data">
      <el-table-column
        :label="$t('id')"
        prop="id"
        min-width="35px"
    ...
    <!-- Paginator -->
    <div v-if="saleInspections.meta.pagination" class="sale-house-inspections__table-pagination" >
      <el-pagination
        :current-page="tablePage"
        :page-sizes="[10, 30, 50, 100]"
        :page-size="tablePageSize"
        :total="saleInspections.meta.pagination.total"
...
export default {
  ...
  methods: {
    ...
    ...mapActions([
      'fetchSaleInspections',
      'deleteSaleInspection'
    ]),
    /**
     * 分页相关
     */
    ...
    previewHouseDetails(houseData) {
      this.setSaleDetailsData(houseData)
    ...
    handleDelete(id) {
      this.$confirm(this.$t('deleteDataTips'), this.$t('tips'), {
        ...
        this.tableLoading = true
        this.deleteSaleInspection({ id }).then(res => {
          this.$message({
