<template>
  <div class="house-sale-container" >
    ...
    <el-dialog
      ...
      width="50%"
      center>
      <div class="house-sale-details" >
        <el-tabs tab-position="left" >
          <el-tab-pane :label="$t('house.basicInformation')" class="house-sale-details__tab-content">
            <h3 class="house-sale-details__tab-title" > {{ $t('house.housingBasicInformation') }} </h3>
            <el-row class="house-sale-details__tab-content-inner house-sale-details__basic-info" >
          ...
          <el-tab-pane :label="$t('house.introduction')" class="house-sale-details__tab-content">
            <h3 class="house-sale-details__tab-title" > {{ $t('house.housingIntroduction') }} </h3>
            <div class="house-sale-details__tab-content-inner house-sale-details__introduction" >
          ...
          <el-tab-pane :label="$t('house.pictureAndVideo')" class="house-sale-details__tab-content">
            <h3 class="house-sale-details__tab-title" > {{ $t('house.introToHousingPicturesAndVideos') }} </h3>
            <div class="house-sale-details__tab-content-inner house-sale-details__photo-and-video" >
          ...
          <el-tab-pane :label="$t('house.rentalRecords')" class="house-sale-details__tab-content">
            <h3 class="house-sale-details__tab-title" > {{ $t('house.rentalRecords') }} </h3>
            <div class="house-sale-details__tab-content-inner house-sale-details__photo-and-video" >
              <el-carousel height="400px">
                <el-carousel-item>
                  <img style="width: 100%;" src="https://www.melbournerealestate.com.au/wp-content/uploads/2014/04/slide6.jpg" alt="">
